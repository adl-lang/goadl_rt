...
func Texpr_IndexMap[K any, V any](k ATypeExpr[K], v ATypeExpr[V]) ATypeExpr[IndexMap[K, V]] {
	return ATypeExpr[IndexMap[K, V]]{
		Value: adlast.TypeExpr{
			TypeRef: adlast.TypeRef{
				Branch: adlast.TypeRef_Reference{
					V: adlast.ScopedName{
...
func AST_IndexMap() adlast.ScopedDecl {
	decl := adlast.Decl{
		Name: "IndexMap",
		Version: Maybe[uint32]{
			Branch: Maybe_Nothing{
...
func init() {
	RESOLVER.Register(
		adlast.ScopedName{ModuleName: "sys.types", Name: "IndexMap"},
		ScopedInfo{
			SD:      AST_IndexMap(),
			TypeMap: map[string]reflect.Type{},
		},
